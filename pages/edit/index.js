...
Page({
  ...
  data: {
    ...
    picConfig: [
      ...
      { text: '晨夕', value: 'Morning' },
      { text: '吃水果', value: 'Fruits' },
      { text: '吃早餐', value: 'Breakfast' },
      { text: '喝水', value: 'DrinkWater' },
      { text: '戒酒', value: 'BanWine' },
      { text: '戒烟', value: 'BanSmoke' },
      { text: '考研', value: 'Exam' },
      { text: '理财', value: 'Money' },
      { text: '练字', value: 'Writng' },
      { text: '跑步', value: 'Running' },
      { text: '陪孩子', value: 'WithChild' },
      { text: '摄影', value: 'TakePhoto' },
      { text: '刷牙', value: 'BrushTeeth' },
      { text: '微笑', value: 'Smile' },
      { text: '英语', value: 'English' },
      { text: '早起', value: 'EarlyUp' },
      { text: '早睡', value: 'EarlySleep' },
      { text: '做饭', value: 'Cook' },
    ],
